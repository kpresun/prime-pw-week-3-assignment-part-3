...
console.log('The last item removed is', removeditem);

// 5. A delivery of 25 more parts arrived. Add the value 25 to the end of the array
console.log('5. Adding 25 to supplyChanges.');

supplyChanges.push(25);
console.log('new item', supplyChanges);
  ...
  if ( supplyChanges[i] > 0 ) {
    console.log( 'Added ' + supplyChanges[i] +' parts' );
      ...
      console.log( 'Part count', supplyChanges[i] );
        ...
        console.log('Supplies did not change');
      }
}
...
for (changes of supplyChanges){
  console.log(changes);
  if ( changes > 0 ) {
    console.log( changes + ' were added');
  }
    else if ( changes < 0 ) {
      console.log( changes + ' supplies removed');
    }
      else {
        console.log('supplies did not change');
      }
...
while ( i < supplyChanges.length) {
  ...
  supplyChanges++;
  if ( supplyChanges > i ) {
    console.log( supplyChanges + ' were added');
  }
    else if ( supplyChanges < i ) {
      console.log( supplyChanges + ' supplies removed');
    }
      else {
        console.log('supplies did not change');
      }
